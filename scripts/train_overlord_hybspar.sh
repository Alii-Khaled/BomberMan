...
#   S2 250: vs warden_v1 + 2x rule_based
...
$PY main.py play --no-gui --agents overlord warden_v1 rule_based_agent rule_based_agent --train 1 --scenario classic --n-rounds $S2 --save-stats results/overlord_hyb_s2.json
fi
...
OVERLORD_DEVICE=cpu $PY main.py play --no-gui --agents overlord warden_v1 rule_based_agent rule_based_agent --train 0 --continue-without-training --scenario classic --n-rounds 60 --seed 0 --save-stats results/overlord_hyb_eval_warden.json
